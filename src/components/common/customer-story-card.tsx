...
const CustomerStoryCard = ({ logo, detailedCase, review, name, position, picture, url }: { logo: string; detailedCase: boolean; review: string; name: string; position: string; url: string; picture: string; }) => {
    return (
        <div className=" p-6 flex flex-col justify-between items-start w-full max-w-[94vw] md:max-w-lg bg-accent rounded-xl border border-black/10 hover:bg-gradient-to-r from-accent to-primary/30">
            <div>
