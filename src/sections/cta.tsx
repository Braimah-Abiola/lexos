        ...
        <section className=" w-full bg-gradient-to-b from-white to-[#E8E2FF]">
            <Wrapper>
                <div className=" w-full flex flex-col items-center z-10 relative">
                    ...
                    <h1 className=" mt-6 md:mt-2 font-manrope text-4xl md:text-5xl md:leading-[60px] font-bold text-center">Automate Your <br />
            ...
            <div className=" w-full h-[20rem] md:h-[38rem] relative -mt-12 md:-mt-40 z-1">
                <Image fill quality={100} src="/assets/cta-img.png" className=" object-cover md:object-contain" alt="Cta" />
            </div>
        </section>
    );
}
