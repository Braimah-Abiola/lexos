    ...
    <div className="flex flex-col md:grid md:grid-cols-2 lg:grid lg:grid-cols-3 gap-4 lg:gap-4 md:max-w-5xl px-6 md:px-0 mx-auto w-full relative z-10 mt-8 md:mt-0">
      ...
      <div className="w-full bg-white px-5 pt-5 pb-10 border border-black/10 rounded-2xl">
        ...
        <Link href="https://app.skillura.com/get-started">
          ...
          >
            {t("getStartedGrowthButton")}
          </motion.button>
        </Link>
        <Separator className=" w-full bg-foreground opacity-10" />

        <p className=" mb-4 mt-4 font-medium text-foreground">{t("notableFeaturesGrowth")}</p>
        <div className="flex items-start gap-2 mb-2">
          <div>
            <Check className=" text-primary" />
          </div>
          <span className="text-base">{t("growthFeature1")}</span>
        </div>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("growthFeature2")}</span>
        </div>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("growthFeature3")}</span>
        </div>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("growthFeature4")}</span>
        </div>
      </div>
      ...
      <div className="w-full overflow-hidden bg-primary px-5 pt-5 pb-10 text-white rounded-2xl">
        ...
        <Link href="https://stripe.com">
          ...
          >
            {t("getStartedAdvancedButton")}
          </motion.button>
        </Link>
        <Separator className="w-full bg-white opacity-20" />

        <p className=" mb-4 mt-4 font-medium text-white">
          {t("advancedFeaturesIntro")}
        </p>
        <div className="flex items-center gap-2 mb-2">
        ...
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-white" />
          <span className="text-base">{t("advancedFeature3")}</span>
        </div>
        <div className="flex items-start gap-2 mb-2">
          <Check className=" text-white" />
      ...
      {/* Enterprise */}
      <div className="w-full bg-white px-5 pt-5 pb-10 border border-black/10 rounded-2xl">
        <p className="text-xl font-semibold font-manrope">{t("enterpriseTitle")}</p>
        ...
        <div className="overflow-hidden mt-4">
          <AnimatePresence mode="wait">
            {selected === "M" ? (
              ...
              >
                <span>{t("enterprisePriceText")}</span>
              </motion.p>
            ) : (
              <motion.p
                key="yearly2"
        ...
        <p className=" mb-4 mt-4 font-medium text-foreground">
          {t("enterpriseFeaturesIntro")}
        </p>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("enterpriseFeature1")}</span>
        </div>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("enterpriseFeature2")}</span>
        </div>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("enterpriseFeature3")}</span>
        </div>
        <div className="flex items-start gap-2 mb-2">
          <div>
            <Check className=" text-primary" />
          </div>
          <span className="text-base">{t("enterpriseFeature4")}</span>
        </div>
        <div className="flex items-center gap-2 mb-2">
          <Check className=" text-primary" />
          <span className="text-base">{t("enterpriseFeature5")}</span>
        </div>
      </div>
    </div>
  );
