            ...
            <Wrapper className="flex flex-col gap-8 md:gap-16">
                ...
                >
                    <motion.div variants={itemVariants} className="w-full md:w-1/3">
                        ...
                        <p className=" text-foreground opacity-70 md:mt-1">{t("designDescription")}</p>
                    </motion.div>
                ...
                >
                    <motion.div variants={itemVariants} className="w-full md:w-1/3">
                        ...
                        <p className=" text-foreground opacity-70 md:mt-1">{t("softwareDevelopmentDescription")}</p>
                    </motion.div>
                    <motion.div className="flex flex-col gap-4 w-full md:w-2/3" variants={itemVariants}>
                ...
                >
                    <motion.div variants={itemVariants} className="w-full md:w-1/3">
                        ...
                        <p className=" text-foreground opacity-70 md:mt-1">{t("otherDescription")}</p>
                    </motion.div>
                    <motion.div className="flex flex-col gap-4 w-full md:w-2/3" variants={itemVariants}>
