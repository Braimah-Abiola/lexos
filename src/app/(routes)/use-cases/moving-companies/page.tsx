            ...
            <Wrapper className=" w-full flex flex-col items-center py-12">
                <div className=" max-w-7xl mx-auto flex flex-col items-center">
                    ...
                    <div className="flex items-center gap-4 mt-6">
                        <Image width={52} height={52} src="/assets/sarah.png" className=" object-cover" alt={t("customerImageAlt")} />
                        <div className=" flex flex-col items-start gap-0">
                            <p className=" font-medium text-lg md:text-xl">{t("customerName")}</p>
