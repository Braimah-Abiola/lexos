        ...
        <main className=" w-full h-screen flex items-center justify-center">
            <Wrapper className=" flex flex-col items-center -mt-40">
                <div className=" w-full md:w-[620px] h-[280px] relative">
                    <Image fill src="/assets/404.svg" className="object-contain" alt="404" />
                </div>
                <h3 className="md:mt-12 font-manrope font-bold text-2xl md:text-3xl text-foreground">Page Not Found</h3>
